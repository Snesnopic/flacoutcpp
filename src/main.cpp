...
static void print_usage(const char* prog) {
    std::cerr
        ...
        << "                       out of 32, ranked by Levinson error (default 3;\n"
        << "                       32 = all). The dominant speed knob. Note windows\n"
        << "                       are worth more than orders per unit of sweep\n"
        << "                       time: 10 windows x 3 orders is both faster and\n"
        << "                       smaller on real music than 4 x 8. Synthetic\n"
        << "                       tonal content is the exception and wants orders.\n"
